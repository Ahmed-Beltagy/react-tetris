...
class Block {
  ...
  rotate() {
    ...
    return {                                                                                                                                                                                  
      shape: result,                                                                                                                                                                          
      type: this.type,                                                                                                                                                                        
      xy: List(nextXy), // Ensure xy is returned as an Immutable List                                                                                                                         
  ...
  fall(n = 1) {
    return {                                                                                                                                                                                  
      shape: this.shape,                                                                                                                                                                      
      type: this.type,                                                                                                                                                                        
      xy: List([this.xy.get(0) + n, this.xy.get(1)]), // Ensure xy is returned as an Immutable List                                                                                           
  ...
  right() {
    return {                                                                                                                                                                                  
      shape: this.shape,                                                                                                                                                                      
      type: this.type,                                                                                                                                                                        
      xy: List([this.xy.get(0), this.xy.get(1) + 1]), // Ensure xy is returned as an Immutable List                                                                                           
      rotateIndex: this.rotateIndex,                                                                                                                                                          
      timeStamp: this.timeStamp, 
    };
  }
